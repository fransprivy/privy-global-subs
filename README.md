...
- **Paywall (M-17)**: pressing Send or New envelope with 0 sends left opens the upgrade paywall (Personal and Business for Free users, Business only for Personal users) with the quota reset date. Sending an envelope in the prototype counts against the workspace quota (UX-28).
