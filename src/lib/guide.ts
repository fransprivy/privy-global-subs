...
export const GUIDES: Record<string, Guide> = {
  ...
  "business-member-personal": {
    ...
    steps: [
      ...
      {
        id: "bmp-ending",
        title: "Owner cancelled: members are warned",
        do: "Avatar menu → Hartono Legal Partners.",
        expect: "Banner B-10: Kenny's Business plan ends on Oct 1, 2026; the workspace becomes read-only then; your own plan is not affected. 'Review envelopes' link.",
        refs: ["B-10"],
        check: (s) => s.activeWorkspace === "ws_kenny",
      },
      {
  ...
  "business-expired": {
    ...
    steps: [
      ...
      {
        id: "bx-3",
        title: "Hand the documents over",
        do: "Back in Privy Product Team → banner or Billing → 'Hand over documents' → confirm.",
        expect: "4 envelopes move to your Individual workspace (they appear on its Home and Envelopes). The Business workspace shows an empty list with the handover date.",
        refs: ["R-79", "UX-08"],
